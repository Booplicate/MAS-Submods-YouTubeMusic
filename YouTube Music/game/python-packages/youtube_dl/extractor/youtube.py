    ...
    _TESTS = [
        ...
        # Non-square pixels
        {
            ...
            'info_dict': {
                ...
                'description': 'made by Wacom from Korea | Zi Mu &Jia You Tian Cu  by TY\'s Allen | Gan Xie heylisa00cavey1001Tong Xue Re Qing Ti Gong Geng Ji Fan Yi ',
                'uploader': 'Sun r',
                'title': '[A-made] Bian Tai Yan Zi Mu Ban  Tai Yan  Wo Jiu Shi Zhe Yang De Ren ',
            },
        },
        # url_encoded_fmt_stream_map is empty string
        {
            ...
            'info_dict': {
                'id': 'qEJwOuvDf7I',
                'ext': 'webm',
                'title': 'Obsuzhdenie sudebnoi praktiki po vyboram 14 sentiabria 2014 goda v Sankt-Peterburge',
                'description': '',
                'upload_date': '20150404',
                'uploader_id': 'spbelect',
                'uploader': 'Nabliudateli Peterburga',
            },
            'params': {
                'skip_download': 'requires avconv',
            },
        ...
        # DASH manifest with segment_list
        {
            ...
            'info_dict': {
                ...
                'uploader': 'Airtek',
                'description': 'Retransmision en directo de la XVIII media maraton de Zaragoza.',
                'uploader_id': 'UCzTzUmjXxxacNnL8I3m4LnQ',
                'title': 'Retransmision XVIII Media maraton Zaragoza 2015',
            },
            'params': {
                'youtube_include_dash_manifest': True,
